...
# 1. User use the joysticks on a PS4 controller, that message is read and published on a ROS2 topic by the node "joystick"
...
def generate_launch_description():
    ...
    joy_node = Node(
    # This node reads the joystick command and publishes it within a ROS2 topic
        package = "joy",
        executable = "joy_node",
        name = "joystick",
